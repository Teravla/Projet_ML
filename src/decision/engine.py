...
def categoriser_confiance(
    ...
    if confiance >= seuils.haute:
        return ConfidenceLevel.CONFIDENCE_HAUTE
    if confiance >= seuils.moyenne:
        return ConfidenceLevel.CONFIDENCE_MOYENNE
    if confiance >= seuils.faible:
        return ConfidenceLevel.CONFIDENCE_FAIBLE
    return ConfidenceLevel.CONFIDENCE_TRES_FAIBLE
